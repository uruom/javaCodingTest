...
public class Question {
	...
	public static int myUpdateBits(int a,int b,int i,int j){
		int c = j-i+1;
		int temp_bit=~(((1<<c)-1)<<i);//构造1..0000..11...的格局
		a =a&temp_bit;//清空a的j到i位
		a = a|(b<<i);
		return a;
	}
	public static void main(String[] args) {
		...
		int myc = myUpdateBits(a,b,29,31);
		System.out.println(AssortedMethods.toFullBinaryString(c));
		System.out.println(AssortedMethods.toFullBinaryString(myc));
	}
}
